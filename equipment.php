...
try {
    ...
    if ($categoryId > 0) {
        ...
        // Lấy TẤT CẢ sản phẩm thiết bị: cả category text VÀ category_id
        $whereClause = "WHERE ((p.category = 'Thiết bị' OR p.category = 'thiết bị') 
                        OR p.category_id IN (SELECT id FROM categories WHERE id = 4 OR parent_id = 4)) 
                        AND p.status = 1";
        $params = [];
    }
    ...
    $equipment = array_slice($allProducts, $offset, $limit);
    
    // Get equipment SUB-CATEGORIES (danh mục con) for filter
    $categoriesQuery = "
...
<body>
    ...
    <section class="materials-hero">
        <div class="hero-content">
            <h1 class="hero-title"><?php echo t('equipment_title'); ?></h1>
            <p class="hero-subtitle">
                <?php echo t('equipment_description'); ?>
            </p>
        </div>
    </section>
    ...
    <div class="main-content">
        ...
        <div class="category-filter">
            <div class="filter-header">
                ...
                <form method="GET" action="" class="search-box">
                    <input type="text" 
                           name="search" 
                           class="search-input" 
                           placeholder="<?php echo t('equipment_search_placeholder'); ?>" 
            ...
            <div class="category-pills">
                <!-- All categories pill -->
                <a href="equipment.php<?php echo !empty($search) ? '?search=' . urlencode($search) : ''; ?>" 
                ...
                <?php foreach ($categories as $cat): ?>
                    ...
                    $url = 'equipment.php?category_id=' . $catId;
                    if (!empty($search)) {
